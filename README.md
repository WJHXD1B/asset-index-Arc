...
**Arc Raiders Steam Build: 25163933 (2026-09-08)**
...
New snapshot tags use `arc-<steam-build-id>-exfil-<exfil-version>`. The current snapshot tag is `arc-25163933-exfil-v0.13.4`.
...
| Metric | Count |
| --- | ---: |
| Unique asset IDs | 4,603 |
| Internal asset names | 4,603 |
| English display names | 3,709 |
| English descriptions | 794 |
| Localization rows | 37,910 |
| Localized display names (de) | 2,775 |
| Localized display names (es) | 2,710 |
| Localized display names (fr) | 2,806 |
| Localized display names (it) | 2,821 |
| Localized display names (ja) | 2,905 |
| Localized display names (ko) | 2,906 |
| Localized display names (pl) | 2,840 |
| Localized display names (pt_br) | 2,852 |
| Localized display names (ru) | 2,906 |
| Localized display names (tr) | 2,859 |
| Localized display names (zh_hans) | 2,906 |
| Localized display names (zh_hant) | 2,906 |
| PNG icons | 799 |
| Wide icon variants | 0 |
...
For production use, pin to a snapshot tag such as `arc-25163933-exfil-v0.13.4` instead of tracking `main`. The dataset is still pre-1.0.0, so schema details may change; update deliberately after checking `schema.json` and this README.
