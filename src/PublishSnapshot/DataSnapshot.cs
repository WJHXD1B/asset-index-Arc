...
// Projection borrows validated files and owns its sorted resource list.
...
internal sealed class DataSnapshot : IDisposable
{
    ...
    internal static readonly string[] Required = ["asset_index.csv", "asset_localizations.csv", "assets.json", "resources.json", "localization/en.jsonl.gz"];
